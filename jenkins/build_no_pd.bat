...
echo "Modifying Makefile to enable NO_PD build"
echo "---------------------------"

REM Backup the config.h
cp config.h config_bkup.h

REM Use PD override
sed -i 's/#define.*CY_SOLN_QI_OVERRIDE_PD.*$/#define CY_SOLN_QI_OVERRIDE_PD (1u)/' config.h
